package com.example.s07150610.toast;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void b1(View v){
        Toast.makeText(this,"你是大傻B",Toast.LENGTH_LONG).show();
    }
    ...
    public void b3(View v){
        ...
        ImageView mImang=new ImageView(this);
        mImang.setImageResource(R.drawable.yellowman);
